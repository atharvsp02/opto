    ...
    <Background>
      <div className="h-screen flex flex-row bg-transparent" >
        ...
        <div className=" w-[50vw] h-[100vh] flex flex-col justify-center ">
          <div className="bg-gray-900/50 backdrop-blur-sm  border-[11px]  border-gray-700/50  border-double   w-[400px] h-[300px] rounded-[80px] shadow-[0_10px_30px_rgba(0,0,0,0.1)] p-8 absolute right-[200px] flex flex-col justify-center items-center">
            <div className="btn" >
