    ...
    <div className='bg-black text-white h-[100vh] flex flex-row gap-4'>
      ...
      <div className='flex-1 pl-[50px] pt-[40px] max-w-[60vw] flex flex-col space-y-6'>
        ...
        <div className='border border-white pl-4 pt-2 p-4 bg-white/20 backdrop-blur-sm rounded-lg shadow-md'>
          <a href="#" className='text-[12px]  rounded-full  py-1 '>5 Traders</a>
          <div className='flex flex-row justify-between'>
            <p className='py-1 mb-11 '>Bitcoin is forecasted to reach at 121767.97 USDT or more at 08:30 PM?</p>
            <img src={Bitcoin} alt="" className='w-[60px] relative  right-4' />
          </div>
          <div className='flex flex-row justify-center pt-4'>
            <button className='bg-[#0064FB] mx-5 px-5 py-2 w-[320px] rounded-md  shadow-xl hover:scale-105 hover:bg-[#0064FB]/90 transition-all'>Yes</button>
            <button className='bg-[#FF414B] mx-5 px-5 py-2 w-[320px] rounded-md  shadow-xl hover:scale-105 hover:bg-[#FF414B]/90 transition-all'>No</button>
          </div>
        </div>
        <div className='border border-white pl-4 pt-2 p-4 bg-white/20 backdrop-blur-sm rounded-lg shadow-md'>
          <a href="#" className='text-[12px]  rounded-full  py-1 '>5 Traders</a>
